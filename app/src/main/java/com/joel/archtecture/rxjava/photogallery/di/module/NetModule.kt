package com.joel.archtecture.rxjava.photogallery.di.module
...
class NetModule {
    ...
    */
    ...
    protected fun provideHttpLoggingInterceptor(): HttpLoggingInterceptor {
        ...
        interceptor.level = if (true) HttpLoggingInterceptor.Level.BODY else HttpLoggingInterceptor.Level.NONE
        return interceptor
    }
    ...
    fun provideRetrofit(gson: Gson,okHttpClient:OkHttpClient): Retrofit {
        return Retrofit.Builder().addConverterFactory(GsonConverterFactory.create(gson))
                ...
                .client(okHttpClient)
                .baseUrl("https://raw.githubusercontent.com/joelshin/photogallery1/master/").build()
